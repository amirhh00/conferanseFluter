...
class Xamarin extends Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.hash !== this.props.hash && nextProps.hash.includes("xamarin")) {
      setTimeout(() => {
        // this.player.play();
...
export default connect(mapStateToProps)(withRouter(Xamarin));
