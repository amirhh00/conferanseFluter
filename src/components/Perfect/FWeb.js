...
class Fweb extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.hash !== this.props.hash && nextProps.hash.includes("fweb")) {
      setTimeout(() => {
        // this.player.play();
...
export default connect(mapStateToProps)(withRouter(Fweb));