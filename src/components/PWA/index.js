...
class PWA extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.hash !== this.props.hash && nextProps.hash.includes("PWA")) {
      setTimeout(() => {
        // this.player.play();
  ...
  render() {
    return (
      <div className={this.state.animateClassNames} style={{display:'flex',flexDirection:'column',alignItems:'center',height:'100%'}} >
        ...
        <img style={{width : '35%'}} src="images/reactLogo.png" />
        <img style={{width : '35%'}} src="images/angularLogo.png" />
        <img style={{width : '35%'}} src="images/workboxLogo.png" />
        <img style={{width : '35%'}} src="images/ionicLogo.png" />
      </div>
    )
  }
}
...
export default connect(mapStateToProps)(withRouter(PWA));
