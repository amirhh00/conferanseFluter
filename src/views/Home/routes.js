...
import Flutter2 from "../../components/Perfect/flutter2";
...
export default [
  ...
  },
  {
    ...
    content: [
      <div style={{ width: "100%", display: "flex", flexDirection: "column" }}>
        <h4 style={{ textAlign: "center" }}>فهرست</h4>
        <br />
        <p style={{ textAlign: "center" }}>
          (معرفی فلاتر (صفحه &#1780; <FaAngleLeft />
        </p>
        <p style={{ textAlign: "center" }}>
          (مقایسه فلاتر (صفحه &#1782; <FaAngleLeft />
        </p>
        <p style={{ textAlign: "center" }}>
          (چرا فلاتر (صفحه &#1777;&#1784; <FaAngleLeft />
        </p>
        <p style={{ textAlign: "center" }}>
          (نتیجه گیری (صفحه &#1778;&#1778; <FaAngleLeft />
        </p>
      </div>,
    ],
  },
  ...
  },
  {
    ...
    content: [
      <div style={{ textAlign: "center" }}>
        ...
        <span style={{ marginRight: "50px" }} className="try">
          فلاتر خوبه؟
        </span>
      </div>,
    ],
  },
  {
    ...
    content: [
      <div dir="rtl">
        ...
        <p style={{ marginRight: 50, lineHeight: "2em" }}>
          <FaAngleLeft /> زبان های Native
        </p>
        <p style={{ marginRight: 50, lineHeight: "2em" }}>
          <FaAngleLeft /> hybrid ها
        </p>
        <p style={{ marginRight: 50, lineHeight: "2em" }}>
          <FaAngleLeft /> ابزار های جاوااسکریپت
        </p>
        <p style={{ marginRight: 50, lineHeight: "2em" }}>
          <FaAngleLeft /> PWA
        </p>
  ...
  },
  {
    ...
    content: [<p> چرا بهتر است فلاتر را یاد بگیریم؟ </p>],
  },
  {
    id: "perfect",
    data: {
  ...
  },
  {
    ...
    content: [
      <p style={{ textAlign: "center" }}>
        <b className="imagination scaling-up">نتیجه گیری</b>
      </p>,
    ],
  },
  {
    ...
    content: [
      <div style={{ textAlign: "right", direction: "rtl" }}>
        ...
        <ul>
          <li>
            <a href="flutter.dev">flutter.dev</a>
          </li>
          <li>
            <a href="youtube.com">youtube.com</a>
          </li>
          <li>
            <a href="pub.dartlang.org">pub.dartlang.org</a>
          </li>
          <li>
            <a href="dart.dev">dart.dev</a>
          </li>
          <li>
            <a href="medium.com">medium.com</a>
          </li>
          <li>
            <a href="medium.com">github.com</a>
          </li>
        </ul>
      </div>,
    ],
